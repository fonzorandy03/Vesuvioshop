...
public class Tipologia extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getParameter("tipologia").compareTo("MaglieGara") == 0) {
			request.getSession().setAttribute("tipologia", "MaglieGara");
		}
		else if (request.getParameter("tipologia").compareTo("Personalizzate") == 0) {
			request.getSession().setAttribute("tipologia", "Personalizzate");
		}
